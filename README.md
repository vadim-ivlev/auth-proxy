...
- -serve default=4400 Запустить приложение на порту
...
----------------------------------------------
Перед сбокой убедитесь, что директория node-apps/node-modules существует. Иначе тестовое приложение не запустится.
