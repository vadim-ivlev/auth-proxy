...
auth-proxy Может быть запущена с различными базами данных 
в качестве хранилища информации о пользователях, приложениях 
и ролях.

Запуск приложения с базой данных SQLite
-----------------
