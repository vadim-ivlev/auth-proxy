...
INSERT INTO app (appname, url, description)         VALUES ('node1'      ,'http://node:3001', 'Express приложение 1. Работает в докере. test0');
INSERT INTO app (appname, url, description)         VALUES ('node2'      ,'http://localhost:3002', 'Тестовое express приложение 2. test0');
